...
export function Chat({ user, prevMessages }: ChatProps) {
  ...
  useEffect(() => {
    ...
    const newSocket = new WebSocket(
      process.env.WS_URL ?? "ws://10.111.41.228:9999/ws"
    );
  ...
  return (
    <>
      ...
      <section className="h-[calc(100%-16rem)] flex flex-col justify-end py-2 px-6">
        <div
